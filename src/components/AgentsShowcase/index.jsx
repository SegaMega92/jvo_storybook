...
const defaultAgents = [
  ...
  },
  {
    ...
    description: 'Раскачка неликвида, вывод новинок и управление ценами на основе данных по воронке продаж, текущих остатков и динамики спроса',
    buttonText: 'На страницу Агента',
  ...
  },
  {
    ...
    iconBg: null,
    description: 'Формирование ставок на АРК и Поиске с привязкой к конверсии карточки и органическим позициям',
    buttonText: 'На страницу Агента',
